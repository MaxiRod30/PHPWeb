...
<?php
    ...
    // convertir datos
    $id             = $regPERS["marcasID"];
    $marcaNOM         = utf8_encode($regPERS["marcasNOM"]);
...
<link rel="stylesheet" href="../../Estilos/styleMarcas2.css" />
...
<div class="w3-main w3-content w3-padding" style="max-width:1000px;margin-top:150px">
    ...
    <h1>Modificar Marca</h1>
        <form id="dataFRM_MARCAS_UP" action="ProcesoMarcaUP.php" method="POST" class="formulario">
            <hr>
            <label id="icon" for="name"><i class="icon-user"></i></label>
            <input type="text" name="nameID" id="idMarcaID" 
            ...
            <label id="icon" for="name"><i class="icon-user"></i></label>
            <input type="text" name="nameMarca" id="idMarcaNOM" 

            <?php echo "value='$marcaNOM'" ?> 

            placeholder="Ingrese nombre de la Marca" required />
            <hr>
            
            <a href="#" class="button" onclick="CheckMARCA_UP()">Modificar</a>
