...
#
# Database structure for database 'grupomj2030session'
#

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `grupomj2030session` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_spanish_ci */;

USE `grupomj2030session`;
...
CREATE TABLE /*!32312 IF NOT EXISTS*/ `usuarios` (
  `usrNAME` varchar(10) COLLATE utf8_spanish_ci NOT NULL,
  `usrPASS` varchar(32) COLLATE utf8_spanish_ci NOT NULL,
  PRIMARY KEY (`usrNAME`),
  UNIQUE KEY `usrNAME` (`usrNAME`),
  KEY `usrNAME_2` (`usrNAME`)
...
REPLACE INTO `usuarios` (`usrNAME`, `usrPASS`) VALUES
	('peteko','202cb962ac59075b964b07152d234b70');
