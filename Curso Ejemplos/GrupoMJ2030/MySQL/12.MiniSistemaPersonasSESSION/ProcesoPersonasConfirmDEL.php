...
<div id="contenido">
  <fieldset id="frm">
   ...
   <form id="dataFRM" action="ProcesoPersonasDEL.php" method="POST">
     <table>
       <tr>
         <td>ID:</td>
         <td>
       ...
       <tr>
         <td>Departamento:</td>
         <td>
           <select id="dataDTO" name="DTO" disabled="true">
              <option value="">-- seleccionar dpto. --</option>
              <?php
                // crear opciones con dpto seleccionado
       ...
       <tr>
         <td colspan="2">
           ...
           <input type="button" value="Cancelar" onclick="SetPage('FormPersonasDEL.php');"/>
         </td>
       </tr>                            
     </table>
   </form>
